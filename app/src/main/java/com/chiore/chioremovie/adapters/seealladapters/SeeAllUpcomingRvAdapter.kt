...
class SeeAllUpcomingRvAdapter() :
    PagingDataAdapter<ResultDto, SeeAllUpcomingRvAdapter.SeeAllUpcomingViewHolder>(
        DiffUtilCallBack()) {

    class SeeAllUpcomingViewHolder(val binding: SeeAllItemBinding) :
    ...
    override fun onBindViewHolder(holder: SeeAllUpcomingViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SeeAllUpcomingViewHolder {
        return SeeAllUpcomingViewHolder(
