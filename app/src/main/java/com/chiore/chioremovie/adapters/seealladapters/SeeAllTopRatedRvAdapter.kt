...
import com.chiore.chioremovie.ui.fragments.seeallfragments.toprated.TopRatedFragmentDirections
import com.chiore.chioremovie.util.Constants.Companion.BASE_IMAGE_URL

class SeeAllTopRatedRvAdapter() :
    PagingDataAdapter<ResultDto, SeeAllTopRatedRvAdapter.SeeAllTopRatedViewHolder>(
        DiffUtilCallBack()) {

    class SeeAllTopRatedViewHolder(val binding: SeeAllItemBinding) :
            ...
            with(binding) {
                ...
                itemView.setOnClickListener { view ->
                    val action = TopRatedFragmentDirections
                        .actionTopRatedFragmentToDetailsFragment(resultDto.id)
    ...
    override fun onBindViewHolder(holder: SeeAllTopRatedViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SeeAllTopRatedViewHolder {
        return SeeAllTopRatedViewHolder(
